...
1. Create a an empty repository (no License or README) on github with the name foodid.git.
2. Push the local repo to github. From within the root directory of your local project execute the following:

```
  git remote add origin https://github.com/(Your Github UserName Here)/foodid.git
